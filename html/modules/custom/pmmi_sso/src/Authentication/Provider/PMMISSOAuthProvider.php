...
namespace Drupal\pmmi_sso\Authentication\Provider;
...
/**
 * Class PMMISSOAuthProvider.
 *
 * @internal
 * @package Drupal\pmmi_sso\Authentication\Provider
 */
class PMMISSOAuthProvider implements PMMISSOAuthProviderInterface {
