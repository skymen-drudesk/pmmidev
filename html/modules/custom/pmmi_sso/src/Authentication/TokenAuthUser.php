...
use Drupal\pmmi_sso\Entity\PMMISSOTokenInterface;
...
class TokenAuthUser implements TokenAuthUserInterface {
   ...
   * The bearer token.
   *
   * @var \Drupal\pmmi_sso\Entity\PMMISSOTokenInterface
   */
  protected $token;
   ...
   *
   * @param \Drupal\pmmi_sso\Entity\PMMISSOTokenInterface $token
   *   The underlying token.
   * @throws \Exception
   *   When there is no user.
   */
  public function __construct(PMMISSOTokenInterface $token) {
    if (!$this->subject = $token->get('auth_user_id')->entity) {
      /** @var \Drupal\pmmi_sso\Entity\PMMISSOTokenInterface $client */
