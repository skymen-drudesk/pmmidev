...
class PMMISSOService {
  ...
  public function __construct(Client $http_client, ConfigFactoryInterface $config_factory, LoggerChannelFactoryInterface $loggerFactory) {
    ...
    $this->logger = $loggerFactory->get('pmmi_sso');
    $this->ssoSettings = static::reformatConfig($config_factory->get('pmmi_sso.settings'));
    $this->ssoAuth = static::reformatConfig($config_factory->get('pmmi_sso.settings'), TRUE);
