...
use Drupal\pmmi_sso\Service\PMMISSOManager;
use Exception;
...
/**
 * Class PMMISSOController.
 *
 * @package Drupal\pmmi_sso\Controller
 */
class PMMISSOController extends ControllerBase {

  /**
   * The Personify SSO Manager.
   *
   * @var \Drupal\pmmi_sso\Service\PMMISSOManager
   */
  protected $ssoManager;

  /**
   * Constructor for PMMISSOController.
   *
   * @param RequestStack $request_stack
   *   The request stack.
   * @param \Drupal\pmmi_sso\Service\PMMISSOManager $sso_manager
   *   The samlauth SAML service.
   */
  public function __construct(
    RequestStack $request_stack,
    PMMISSOManager $sso_manager
  ) {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('pmmi_sso.manager')
    );
  }
