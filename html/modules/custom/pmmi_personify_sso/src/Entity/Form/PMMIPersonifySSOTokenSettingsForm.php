 ...
 * @internal
 */
class PMMIPersonifySSOTokenSettingsForm extends FormBase {
  ...
  public function getFormId() {
    return 'pmmi_personify_sso_token_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['expiration'] = [
      ...
      '#default_value' => $this->config('pmmi_personify_sso.settings')->get('expiration'),
    ];
    $form['submit'] = [
      '#type' => 'submit',
      '#value' => $this->t('Save'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $settings = $this->configFactory()->getEditable('pmmi_personify_sso.settings');
