...
class PMMIPersonifySSOSettings extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['gateway']['check_frequency'] = array(
      ...
      '#options' => array(
        PMMIPersonifySSOHelper::CHECK_NEVER => 'Disable gateway feature',
        PMMIPersonifySSOHelper::CHECK_ONCE => 'Once per browser session',
        PMMIPersonifySSOHelper::CHECK_ALWAYS => 'Every page load (not recommended)',
        PMMIPersonifySSOHelper::CHECK_TOKEN_TTL => 'Every page load, if token TTL not expired',
      ),
    );
