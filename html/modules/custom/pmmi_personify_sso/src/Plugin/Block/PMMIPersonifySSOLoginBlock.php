...
namespace Drupal\pmmi_personify_sso\Plugin\Block;
...
/**
 * Provides a 'PMMIPersonifySSOLoginBlock' block.
 *
 * @Block(
 *  id = "pmmi_personify_sso_login_block",
 *  admin_label = @Translation("PMMI Personify SSO Login Block"),
 *  category = @Translation("PMMI")
 * )
 */
class PMMIPersonifySSOLoginBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function __construct(
    ...
    $this->personifySSOConfig = $config_factory->get('pmmi_personify_sso.settings');
  }
  ...
  public function build() {
    $build = [];
    /** @var \Drupal\pmmi_personify_sso\Service\PMMIPersonifySSOService $sso_service */
    $sso_service = \Drupal::service('pmmi_personify_sso.service');
