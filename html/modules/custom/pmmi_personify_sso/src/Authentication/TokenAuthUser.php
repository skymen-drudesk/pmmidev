...
use Drupal\pmmi_personify_sso\Entity\PMMIPersonifySSOTokenInterface;
...
class TokenAuthUser implements TokenAuthUserInterface {
   ...
   * The bearer token.
   *
   * @var \Drupal\pmmi_personify_sso\Entity\PMMIPersonifySSOTokenInterface
   */
  protected $token;
   ...
   *
   * @param \Drupal\pmmi_personify_sso\Entity\PMMIPersonifySSOTokenInterface $token
   *   The underlying token.
   * @throws \Exception
   *   When there is no user.
   */
  public function __construct(PMMIPersonifySSOTokenInterface $token) {
    if (!$this->subject = $token->get('auth_user_id')->entity) {
      /** @var \Drupal\pmmi_personify_sso\Entity\PMMIPersonifySSOTokenInterface $client */
