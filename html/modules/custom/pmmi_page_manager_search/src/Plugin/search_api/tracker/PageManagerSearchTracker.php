...
namespace Drupal\pmmi_page_manager_search\Plugin\search_api\tracker;
...
/**
 * Class PageManagerSearchTracker.
 *
 *  @SearchApiTracker(
 *   id = "page_manager_search_tracker",
 *   label = @Translation("Page Manager Search Tracker"),
 * )
 */
class PageManagerSearchTracker extends TrackerPluginBase implements TrackerInterface {
